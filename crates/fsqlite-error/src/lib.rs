...
impl FrankenError {
    ...
    /// [`crate::FrankenError`]-producing whole-image publication surfaces:
    /// `Connection::publish_database_image`,
    /// `Connection::publish_database_image_from_receipt`,
    /// `Connection::publish_database_image_from_receipt_with_bounded_validation`,
    /// or the corresponding pager publication primitive. Those surfaces enforce
    /// the invariant that:
    ///
