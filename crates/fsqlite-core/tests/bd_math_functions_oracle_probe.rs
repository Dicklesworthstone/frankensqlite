...
fn math_functions_match_rusqlite_oracle() {
    asupersync::test_utils::run_test(|| async {
        ...
        let exprs = [
            ...
            // Integer TEXT must stay exact and INTEGER after numeric coercion.
            // Keep one expression per query: fval/rval compare the first column.
            "SELECT ceil('42')",
            "SELECT typeof(ceil('42'))",
            "SELECT ceil('9007199254740993')",
            "SELECT ceiling('+9007199254740993')",
            "SELECT floor('-9007199254740993')",
            "SELECT trunc('9007199254740993')",
            "SELECT ceil('9223372036854775807')",
            "SELECT floor('-9223372036854775808')",
            "SELECT trunc('+9223372036854775807')",
            "SELECT ceiling('-9223372036854775808')",
            "SELECT floor('+0009007199254740993')",
            "SELECT ceil('-0009007199254740993')",
            "SELECT ceil('-0')",
            "SELECT typeof(trunc('-0'))",
            "SELECT typeof(ceil('42.0'))",
            "SELECT typeof(floor('42e0'))",
            "SELECT typeof(trunc('-0.0'))",
            "SELECT ceil('9223372036854775808')",
            "SELECT typeof(ceil('9223372036854775808'))",
            "SELECT floor('-9223372036854775809')",
            "SELECT typeof(floor('-9223372036854775809'))",
            "SELECT floor(char(11)||'+9007199254740993'||char(11))",
            "SELECT trunc(char(12)||'-9007199254740993'||char(12))",
            "SELECT ceil(char(9)||char(10)||char(13)||' +42 '||char(13)||char(10)||char(9))",
            "SELECT ceil('42tail')",
            "SELECT floor('+ 42')",
            "SELECT trunc('')",
            "SELECT ceiling(x'3432')",
            "SELECT ceil(NULL)",
