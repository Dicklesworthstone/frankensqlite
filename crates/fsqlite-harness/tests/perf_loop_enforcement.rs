...
use perf_loop::{
    ...
    OpportunityMatrixEntry, OptimizationLever, PerfLoopError, PerfSmokeArtifacts, PerfSmokeReport,
    PerfSmokeSystem, ScheduleEvent, build_measurement_artifact_bundle, capture_golden_checksums,
    compute_opportunity_score, compute_trace_fingerprint, enforce_baseline_capture,
    enforce_extreme_optimization_loop, enforce_one_lever_rule, enforce_opportunity_matrix_gate,
    enforce_opportunity_matrix_required, enforce_opportunity_score_gate, ensure_baseline_layout,
    evaluate_opportunity_matrix, load_and_validate_smoke_report, parse_git_diff_changed_paths,
    record_measurement_env, replay_schedule_from_fingerprint, run_deterministic_measurement,
    validate_baseline_layout, validate_measurement_env, validate_opportunity_matrix,
    validate_perf_smoke_report, verify_golden_checksums, write_baseline_gitkeep_files,
