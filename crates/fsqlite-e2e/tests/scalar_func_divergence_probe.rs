...
const EXPRS: &[&str] = &[
    ...
    "json_remove('[0,1,2]','$[1]')",
    "json_patch('{\"a\":1}','{\"b\":2}')",
    // ---- DEEPER BATCH 2 (2026-08-18) ----
    // printf alt-form-2 on %e/%g with precision (adjacent to bd-cgkwp %f fix)
    "printf('%!e', 3.14159)",
    "printf('%!.2e', 3.14159)",
    "printf('%!g', 100000.0)",
    "printf('%!.3g', 1.5)",
    ...
    "length('héllo')",
    // date/time modifiers
    "strftime('%G-%V','2024-01-01')",
    "strftime('%u %w','2024-06-16')",
    "date('2024-06-15','+1 month','start of day')",
    "date('2024-01-31','+1 month','-1 day')",
    "datetime('2024-06-15','+36 hours')",
    "strftime('%Y%m%d','2024-06-15','localtime','utc')",
    "julianday('2024-06-15','+0.5 days')",
    "strftime('%s','2024-06-15') + 0",
    "date('2024-06-15','+1.5 months')",
    "time('now','+1 hour') IS NOT NULL",
    // math edges
    ...
    "atan2(0,0)",
    "1.0/3.0",
    "cast(9.999999999999999e17 as integer)",
    "0.1 + 0.2",
    "9223372036854775807 * 2",
    "abs(-2147483648)",
    // misc / cast / null semantics
    "cast('inf' as real)",
    "cast('nan' as real)",
    "cast('1e309' as real)",
    "cast('-0' as integer)",
