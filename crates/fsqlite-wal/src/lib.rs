...
pub use parallel_wal::{
    ...
    PARALLEL_WAL_MAX_DURABLE_CERTIFICATE_RECORD_SIZE, PARALLEL_WAL_PUBLICATION_SCENARIO_ID,
    PARALLEL_WAL_STAGE_SCENARIO_ID, ParallelWalBatch, ParallelWalCombinerError,
    ParallelWalCombinerMetricsSnapshot, ParallelWalCommitCertificate, ParallelWalConfig,
    ParallelWalConservativeShadowEvidence, ParallelWalControlSurface, ParallelWalCoordinator,
    ParallelWalDecisionAction, ParallelWalDecisionRecord, ParallelWalDurabilityCombiner,
    ParallelWalDurabilityReceipt, ParallelWalDurabilityRequest,
    ParallelWalDurableCertificateRecord, ParallelWalFallbackReason, ParallelWalFrame,
    ParallelWalFramePayloadDigestBuilder, ParallelWalLaneBatch, ParallelWalLaneStager,
    ParallelWalLookupMode, ParallelWalOperatingMode, ParallelWalOrderedResidue,
