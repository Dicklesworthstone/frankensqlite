#!/usr/bin/env python3
# VARIANT: interleaved read = ONLY in-transaction PRAGMA integrity_check.
...
for c in range(CYCLES):
    ...
    L.append(f"-- cycle {c} in-txn integrity_check")
    L.append("PRAGMA integrity_check;")   # ONLY interleaved read, INSIDE txn
    L.append("COMMIT;")
L.append("PRAGMA integrity_check;")  # final, after commit
open("/tmp/icheck.sql","w").write("\n".join(L)+"\n")
print("wrote icheck")
