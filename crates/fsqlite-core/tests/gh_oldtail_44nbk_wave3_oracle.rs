...
/// rusqlite reference.
///
/// Legacy DQS is enabled by default (bd-jcjkf). An unresolved double-quoted
/// identifier in this supported query shape must fall back to a string, as
/// it does in the bundled SQLite reference.
#[test]
