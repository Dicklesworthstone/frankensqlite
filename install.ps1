...
.PARAMETER Version
Exact release tag to install, such as v0.1.16. Defaults to the latest release.
...
.EXAMPLE
.\install.ps1 -Version v0.1.16 -Destination C:\Tools\FrankenSQLite

Installs an exact release to a custom directory.

.EXAMPLE
.\install.ps1 -Version v0.1.16 -OfflineArchive .\fsqlite-0.1.16-windows_amd64.zip -Checksum $sha256 -KeepTemp
